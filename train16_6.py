...
#ema = 0.1
#proportion1 = torch.linspace(0, 1, 3)
#proportion1 = torch.zeros(1)
#proportion2 = torch.ones(299)
#proportion = torch.cat((proportion1, proportion2), dim=0)
...
for epoch in range(300):
    ...
    for x1, _ in unlabeled_loader:
        ...
        for chosen in num_loader:
            ...
            #loss1 = proportion[epoch] * loss_sup1 + (1-proportion[epoch]) * loss_self1
            #loss2 = proportion[epoch] * loss_sup2 + (1-proportion[epoch]) * loss_self2
            #loss1 = loss_sup1 + proportion[epoch] * loss_self1
            #loss2 = loss_sup2 + proportion[epoch] * loss_self2
            ...
            #loss[chosen[0]] = loss1.item()#proportion[epoch] * loss_sup1.item() + (1-proportion[epoch]) * loss_self1.item()
            #loss[chosen[1]] = loss2.item()#proportion[epoch] * loss_sup2.item() + (1-proportion[epoch]) * loss_self2.item()
            #cnt[chosen[0]] += 1
            #cnt[chosen[1]] += 1
