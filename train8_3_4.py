...
from ViT_patchloss6_3 import PairContrastiveLoss
...
eps = torch.linspace(0.1, 0.1, 300)
...
for epoch in range(300):
    ...
    for x1, _ in unlabeled_loader:
        ...
        loss_sup = criterion1(con0_s, eps[epoch]) + criterion2(output0_s, y0) 
        loss_sup.backward()
        optimizer1.step()
        ...
        loss_self = criterion1(con1_s, eps[epoch])
        loss_self.backward()
        optimizer2.step()
