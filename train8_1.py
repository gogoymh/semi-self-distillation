...
criterion1_1 = PairContrastiveLoss(2, 8, 1, latent=256)
criterion1_2 = PairContrastiveLoss(2, 8, 1, latent=256)
...
criterion1_1.to(device)
criterion1_2.to(device)
#criterion1.eval()
criterion2 = cfg.DiceLoss()

param = list(student.parameters()) + list(criterion1_1.parameters()) + list(criterion1_2.parameters()) + list(output1.parameters()) + list(head1.parameters())
...
for epoch in range(300):
    ...
    for x1, _ in unlabeled_loader:
        ...
        loss_self = criterion1_1(con0_s) + criterion1_1(con1_s) + criterion1_2(con0_s) + criterion1_2(con1_s)
