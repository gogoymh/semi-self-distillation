...
class Our_Unet_singlegpu(nn.Module):
    def __init__(self):
        ...
        #self.deconv_u4 = create_upconv_single(in_channels=filters[4], out_channels=filters[3], size=(55,70), inter_capacity=16, num_scale=16, kernel=5)
        #self.deconv_u4 = create_upconv_single(in_channels=filters[4], out_channels=filters[3], size=(32,32), inter_capacity=16, num_scale=16, kernel=5)
        ...
        #self.deconv_u3 = create_upconv_single(in_channels=filters[3], out_channels=filters[2], size=(110,141), inter_capacity=16, num_scale=8, kernel=5)
        #self.deconv_u3 = create_upconv_single(in_channels=filters[3], out_channels=filters[2], size=(64,64), inter_capacity=16, num_scale=8, kernel=5)
        ...
        #self.deconv_u2 = create_upconv_single(in_channels=filters[2], out_channels=filters[1], size=(221,282), inter_capacity=16, num_scale=4, kernel=3)
        #self.deconv_u2 = create_upconv_single(in_channels=filters[2], out_channels=filters[1], size=(128,128), inter_capacity=16, num_scale=4, kernel=3)
        ...
        #self.deconv_u1 = create_upconv_single(in_channels=filters[1], out_channels=filters[0], size=(442,565), inter_capacity=16, num_scale=2, kernel=3)
        #self.deconv_u1 = create_upconv_single(in_channels=filters[1], out_channels=filters[0], size=(256,256), inter_capacity=16, num_scale=2, kernel=3)
        ...
        #self.conv1x1_out = nn.Conv2d(filters[0], 6, 1, 1, 0, bias=False)
