...
criterion1 = PairContrastiveLoss(1, 8, 1, latent=512)
...
param = list(student.parameters()) + list(criterion1.parameters()) + list(head1.parameters())
...
for epoch in range(300):
    ...
    for x1, _ in unlabeled_loader:
        ...
        y0 = y0.float().squeeze().to(device)
        
        rep0_s = student(x0)
        con0_s = head1(rep0_s)
        
        loss_sup = criterion2(con0_s, y0)
        ...
        loss_self = criterion1(con0_s) + criterion1(con1_s)
