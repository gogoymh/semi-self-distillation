...
from ViT_patchloss9 import PairContrastiveLoss
...
label_maker = PairContrastiveLoss(2)
...
param1 = list(student.parameters()) + list(output1.parameters())
...
for epoch in range(300):
    ...
    for x1, _ in unlabeled_loader:
        ...
        loss_sup = criterion(output0_s, y0)
        ...
        if epoch >= 5:
            ...
            y1 = label_maker(output1_s)
            
            loss_self = criterion(output1_s, y1.detach())
