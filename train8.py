...
param = list(student.parameters()) + list(output1.parameters()) + list(head1.parameters())# + list(head2.parameters())+ list(teacher.parameters())+ list(output2.parameters())
