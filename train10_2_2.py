...
from ViT_patchloss7_1 import PairContrastiveLoss
...
criterion1 = PairContrastiveLoss(1, 128, 32, 8, 1)
...
param1 = list(student.parameters()) + list(criterion1.parameters()) + list(output1.parameters())# + list(head1.parameters())# + list(head2.parameters())+ list(teacher.parameters())+ list(output2.parameters())
...
for epoch in range(300):
    ...
    for x0, y0 in labeled_loader:
        ...
        loss_sup = criterion1(rep0_s, y0) + criterion2(output0_s, y0)
        loss_sup.backward()
        optimizer1.step()
    ...
    for x1, _ in unlabeled_loader:
        ...
        loss_self = criterion1(rep1_s, output1_s)
        loss_self.backward()
