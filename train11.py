...
from ViT_patchloss8 import PairContrastiveLoss
...
criterion1 = PairContrastiveLoss(channel=32, hidden=8, size=8, padding=0, latent=128)
...
for epoch in range(300):
    ...
    for x1, _ in unlabeled_loader:
        ...
        loss_sup = criterion1(rep0_s) + criterion2(output0_s, y0)

        x1 = x1.float().to(device)        
        
        rep1_s = student(x1)  
        loss_self = criterion1(rep1_s)
