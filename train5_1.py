...
from ViT_patchloss3 import PairContrastiveLoss
...
criterion1 = PairContrastiveLoss(32, 16, 4)
...
param = list(student.parameters()) + list(criterion1.parameters())# + list(head1.parameters()) # + list(teacher.parameters()) # # + list(head2.parameters())
...
for epoch in range(300):
    ...
    for x1, _ in unlabeled_loader:
        ...
        loss_self = criterion1(rep1_s, rep1_s)# output1_t)#.detach()) + criterion1(output1_t, output1_s.detach())
