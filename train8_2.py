...
head1 = nn.Conv2d(1, 8, 1, 1, 0, bias=True).to(device)
...
criterion1 = PairContrastiveLoss(8, 4, 1)
...
for epoch in range(300):
    ...
    for x1, _ in unlabeled_loader:
        ...
        con0_s = head1(output0_s)
        con1_s = head1(output1_s)

        loss_self = criterion1(con1_s) + criterion1(con0_s)
